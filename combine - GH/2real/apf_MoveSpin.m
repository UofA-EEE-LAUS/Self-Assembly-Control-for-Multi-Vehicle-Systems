...
[returnCode,laser_sensor]=vrep.simxGetObjectHandle(clientID,'laser_sensor0',vrep.simx_opmode_oneshot_wait);
...
[returnCode,dstate, detectedPoint,handle_ob] = vrep.simxReadProximitySensor(clientID, laser_sensor0,vrep.simx_opmode_blocking); %start measuring

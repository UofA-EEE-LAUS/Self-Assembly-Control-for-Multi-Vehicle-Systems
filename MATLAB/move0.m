...
tic
    ...
    [returnCode,rover0]=vrep.simxGetObjectHandle(clientID,strcat('rover0'),vrep.simx_opmode_blocking);
    [returnCode,positiond]=vrep.simxGetObjectPosition(clientID,rover0,-1,vrep.simx_opmode_blocking);
    dy=(y-positiony);
    dphi = 2 / 180 * pi;
    ...
    %defining motor handles
        ...
        [returnCode,motor00]=vrep.simxGetObjectHandle(clientID,'motor00',vrep.simx_opmode_blocking);
        [returnCode,motor10]=vrep.simxGetObjectHandle(clientID,'motor10',vrep.simx_opmode_blocking);
        [returnCode,motor20]=vrep.simxGetObjectHandle(clientID,'motor20',vrep.simx_opmode_blocking);
        %setting motor speeds for straight line
        [returnCode]=vrep.simxSetJointTargetVelocity(clientID,motor00,v0,vrep.simx_opmode_blocking);
        [returnCode]=vrep.simxSetJointTargetVelocity(clientID,motor10,v1,vrep.simx_opmode_blocking);
        [returnCode]=vrep.simxSetJointTargetVelocity(clientID,motor20,v2,vrep.simx_opmode_blocking);
        %get position
[returnCode,rover0]=vrep.simxGetObjectHandle(clientID,strcat('rover0'),vrep.simx_opmode_blocking);
[returnCode,position]=vrep.simxGetObjectPosition(clientID,rover0,-1,vrep.simx_opmode_blocking);
positionx=position(:,1);

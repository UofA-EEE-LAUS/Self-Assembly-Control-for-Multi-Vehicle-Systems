...
detection = max(obplot)+0.1; % the obstacle avoidance reaction range, if the distance between obstacle and robot is smaller than the range, then repulsion affcet its movement, otherwise repulsion is 0
Ke=1;

% The EXTERNAL POTENTIAL FIELD (Local Minima avoidance)
...
% output that is the direction of rover
